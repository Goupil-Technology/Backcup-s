...
BACKUP_PATH = "/backup.backup/archives"
LOG_PATH = "/script_backup/backup.log"

INTERVAL_BACKUP = [7, 14, 21, 28, 30]
BACKUP_PATH_SEMAINE = "/backup.backup/archives/sauvegarde_semaine"
BACKUP_PATH_MOIS = "/backup.backup/archives/sauvegarde_mois"
...
def copie_cycle(BACKUP_PATH, filename):
    print("enter")
    for i in filename:
        path = "/backup.backup/archives/"+str(i)
